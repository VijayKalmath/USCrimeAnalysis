...
In the above time series plot of the rates of different types of crimes over the last decade,we can see that instaces of Simple Assault have remained the almost the same showing some evidence for an inherent presence of bias to harm others based on an identity within a portion of the population. This can be looked upon as a social issue that needs large scale reformation of how people percieve others in general and changes in education might help to mitigate it.
...
From the above stacked bar plots, we can infer that the number of hate crimes commited by adults increased to almost 3 folds between 2013 to 2019.

Although the number of hate crime offenses by minors remain low compared to the number of hate crimes commited by adults, there is a gradual increase in the numbers which was also hinted by rise in number of hate crimes obsereved in schools/colleges in the first graph.
...
From the above plot, we can infer that in general, the crimes commited against women due to a bias are much larger in number compared to hate crime commited against women.

However between 2017-2019, we can see a significant rise in hate crimes against men. This may not be purely due to their identification as a male but have additonal correlation to their sexual orientation (perhaps a rise in homophobia).
...
From the above heatmap we can analyse the various categories of crimes commited by minors faceted over gender. For crimes like Larceny, Drug Abuse, Liquor Law violation and Simple Assault, the number of crimes conducted by males signficantly higher than those conducted
by females.
...
The above heatmaps shows us the number of crimes commited by minors from different ethnic and racial backgrounds. We can observe that the highest number of crimes are commited by minors who identify as African Americans or Blacks. This is a quite interesting observation since in the above plots we have seen that the majority of hate crimes by ethnicity bias were against Black Individuals. This gives a sense of inherent "corrective bias" or aggrevation in young individuals as a response to the hate crimes commited against their community over the years.

## Top Juvenille Crimes by Gender
...
The above Radar charts give us a better spatial outlook of the number of crimes (top 5) commited by minors belonging to a particular gender.

## Top Juvenille Crimes by Race
...
The above Radar charts give us a better spatial outlook of the number of crimes (top 5) commited by minors belonging to a particular race.
